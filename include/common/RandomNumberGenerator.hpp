...
#ifndef RANDOMNUMBERGENERATOR_HPP1_
#define RANDOMNUMBERGENERATOR_HPP1_
...
template<typename Dtype>
boost::random::mt19937 rrl::RandomNumberGenerator<Dtype>::rngGenerator(time(NULL));
template<typename Dtype>
std::mutex rrl::RandomNumberGenerator<Dtype>::rndMutex_;

#endif /* RANDOMNUMBERGENERATOR_HPP1_ */
