...
#ifndef rrl_TRAJECTORY_HPP
#define rrl_TRAJECTORY_HPP
...
class Trajectory {
 ...
 public:
  ...
  void terminateTrajectoryAndUpdateValueTraj(rai::TerminationType termTypeArg,
                                             State &terminalState,
  ...
  void clear() {
    ...
    accumCostTraj.clear();
    valueTraj.clear();
    termType = rai::TerminationType::not_terminated;
    gaeUpdated = false;
    matrixUpdated = false;
  ...
  rrl::Tensor<Dtype, 1> &getGAE(Vfunction_ *vfunction,
                                Dtype gamma,
                                Dtype lambda,
                                Dtype terminalCost) {
