...
# 1 /home/grasping/project/legged/rrl/out/logs/logsNplots/2022-03-09-11-56-18 gpu,0 Vfunction MLP tanh 1e-3 97 192 128 1
# arguments
...
# Import moduleswith tf.device(Dev_list[0]):  # Base device(cpu mode: cpu0, gpu mode: first gpu on the list)
