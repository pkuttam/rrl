...
*       learning state =
  ...
  inline void conversion_LearningState2GeneralizedState(const State &state,
    ...
    rai::Quaternion quat = rrl::Math::MathFunc::rotMatToQuat(R_b);
...
//  rai_sim::HeightMapHandle terrain_;
  ...
  std::vector<rai::Position> defaultCollisionBodyPositions_;
  std::vector<rai::Position> defaultCollisionBodyProps_;
 ...
 std::array<double, 4> footFriction_;
  std::vector<rai::Position> footContactVel_;
  std::vector<rai::Position> footNormal_;
  rai::Position COMPosition_;
